...
class Day:
    def __init__(self, dayOfWeek, day, rating, workedOut, meditated, bankAmount, investments, eventsList, personList):
...
def getDayList():
    ...
    for row in data['results']:
        ...
        # Create Person List
        personList = []
        for hang in row['properties']['Hangout']['multi_select']:
            personList.append([hang['name'], 'Hangout'])
        for vHang in row['properties']['VirtualHangout']['multi_select']:
            personList.append([vHang['name'], 'VirtualHangout'])
        for conv in row['properties']['VirtualConversation']['multi_select']:
            personList.append([conv['name'], 'VirtualConversation'])
